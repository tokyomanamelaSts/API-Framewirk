...
public class TC_013 extends PartyApiSitPayloads {
	...
	public static void PersonVerification_RiskRating_High_Passport(ExtentReports extent) throws URISyntaxException, SAXException, IOException, ParserConfigurationException {
		...
		Response response;
		response =  ApiHelper.sendRestPostRequest(PartyVerificationSitUrl,PartySubKey,PartySubId, PersonVerificationRRHighPassport,"/Person/A08977150/Verification");
