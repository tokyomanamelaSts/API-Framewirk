...
public class TC_003 extends PartyApiUatPayloads {
...
public static void PersonIdentification_Enhanced(ExtentReports extent) throws URISyntaxException, SAXException, IOException, ParserConfigurationException {
	...
	Response response;
	response =  ApiHelper.sendRestPostRequest(PartyVerificationUATUrl,PartySubKey, PartySubId,PersonIndentificationEnhanced, "/Person/9706145018084/Identification");
