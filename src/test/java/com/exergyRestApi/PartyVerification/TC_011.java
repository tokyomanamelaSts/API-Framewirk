...
public class TC_011 extends PartyApiSitPayloads {
	...
	public static void PersonVerification_RiskRating_Low_Passport(ExtentReports extent) throws URISyntaxException, SAXException, IOException, ParserConfigurationException {
		...
		Response response;
		response =  ApiHelper.sendRestPostRequest(PartyVerificationSitUrl,PartySubKey,PartySubId, PersonVerificationRRLowPassport,"/Person/A2886345/Verification");
