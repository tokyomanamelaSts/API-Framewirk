...
public class TC_014 extends PartyApiSitPayloads{
	...
	public static void PersonVerification_RiskRating_High_Passport(ExtentReports extent) throws URISyntaxException, SAXException, IOException, ParserConfigurationException {
		...
		Response response;
		response =  ApiHelper.sendRestPostRequest(PartyVerificationSitUrl,PartySubKey,PartySubId, PersonVerificationRRHighPassport,"/Person/A11111111/Verification");
