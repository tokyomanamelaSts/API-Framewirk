...
public class TC_001 extends PartyApiUatPayloads {
	...
	public static void  TC_001_PersonIdentification_Basic(ExtentReports extent) throws URISyntaxException, SAXException, IOException, ParserConfigurationException {
		...
		Response response;
		response =  ApiHelper.sendRestPostRequest(PartyVerificationUATUrl,PartySubKey, PartySubId,PersonIndentificationBasic, "/Person/9706145018084/Identification");
