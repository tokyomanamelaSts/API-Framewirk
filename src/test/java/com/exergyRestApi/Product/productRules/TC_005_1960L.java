...
public class TC_005_1960L {
	
	public static void  Tc_005_1960L(ExtentReports extent) throws URISyntaxException, SAXException, IOException, ParserConfigurationException {
		...
		ExtentTest test;
		test=extent.createTest("TC_005_1960L");
		Response response;
