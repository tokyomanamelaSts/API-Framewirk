...
public class Product_1960E_TestCases extends ProductsRateRepo{
	...
	public static void  Product_1960E(ExtentReports extent, String filename) throws URISyntaxException, SAXException, IOException, ParserConfigurationException, FilloException {
		...
		while(recordset.next()){
			...
			if(statusCode.equals(String.valueOf(response.statusCode()))) {
				...
				String partnerPremAmount_Retirement10K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(0).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R10 000", partnerRetirementPaidUp10K, partnerPremAmount_Retirement10K, test);
				
				String partnerPremAmount_Retirement15K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(1).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R15 000", partnerRetirementPaidUp15K, partnerPremAmount_Retirement15K, test);
				
				String partnerPremAmount_Retirement20K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(2).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R20 000", partnerRetirementPaidUp20K, partnerPremAmount_Retirement20K, test);
				
				String partnerPremAmount_Retirement25K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(3).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R25 000", partnerRetirementPaidUp25K, partnerPremAmount_Retirement25K, test);
				
				String partnerPremAmount_Retirement30K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(4).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R30 000", partnerRetirementPaidUp30K, partnerPremAmount_Retirement30K, test);
				
				String partnerPremAmount_Retirement35K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(5).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R35 000", partnerRetirementPaidUp35K, partnerPremAmount_Retirement35K, test);
				
				String partnerPremAmount_Retirement40K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(6).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R40 000", partnerRetirementPaidUp40K, partnerPremAmount_Retirement40K, test);
				
				String partnerPremAmount_Retirement45K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(7).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R45 000", partnerRetirementPaidUp45K, partnerPremAmount_Retirement45K, test);
				
				String partnerPremAmount_Retirement50K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(8).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R50 000", partnerRetirementPaidUp50K, partnerPremAmount_Retirement50K, test);
		
				String partnerPremAmount_Retirement55K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(9).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R55 000", partnerRetirementPaidUp55K, partnerPremAmount_Retirement55K, test);
		
				String partnerPremAmount_Retirement60K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(10).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R60 000", partnerRetirementPaidUp60K, partnerPremAmount_Retirement60K, test);
		
				String partnerPremAmount_Retirement65K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(11).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R65 000", partnerRetirementPaidUp65K, partnerPremAmount_Retirement65K, test);
		
				String partnerPremAmount_Retirement70K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(12).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R70 000", partnerRetirementPaidUp70K, partnerPremAmount_Retirement70K, test);
		
				String partnerPremAmount_Retirement75K = innerJson.getJSONArray("lifesAssured").getJSONObject(1).getJSONArray("benefits").getJSONObject(1).getJSONArray("premiums").getJSONObject(13).get("premiumAmount").toString();
				ApiHelper.AssertEquals("Funeral Benefit with Retirement Paid Up	 for parent premium amount on R75 000", partnerRetirementPaidUp75K, partnerPremAmount_Retirement75K, test);
	...
	// Parent
				...
				String ParentPremAmount10K = innerJson.getJSONArray("lifesAssured").getJSONObject(3).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(0).get("premiumAmount").toString();
				ApiHelper.AssertEquals("FuneralBenefit Parent premium amount on R10 000 ", ParentPremiumAmount10K, ParentPremAmount10K, test);
				
				String ParentPremAmount15K = innerJson.getJSONArray("lifesAssured").getJSONObject(3).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(1).get("premiumAmount").toString();
				ApiHelper.AssertEquals("FuneralBenefit Parent premium amount on R15 000", ParentPremiumAmount15K, ParentPremAmount15K, test);
				
				String ParentPremAmount20K = innerJson.getJSONArray("lifesAssured").getJSONObject(3).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(2).get("premiumAmount").toString();
				ApiHelper.AssertEquals("FuneralBenefit Parent premium amount on R20 000", ParentPremiumAmount20K, ParentPremAmount20K, test);
				
				String ParentPremAmount25K = innerJson.getJSONArray("lifesAssured").getJSONObject(3).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(3).get("premiumAmount").toString();
				ApiHelper.AssertEquals("FuneralBenefit Parent premium amount on R25 000", ParentPremiumAmount25K, ParentPremAmount25K, test);
				
				String ParentPremAmount30K = innerJson.getJSONArray("lifesAssured").getJSONObject(3).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(4).get("premiumAmount").toString();
				ApiHelper.AssertEquals("FuneralBenefit Parent premium amount on R30 000", ParentPremiumAmount30K, ParentPremAmount30K, test);
				
				String ParentPremAmount35K = innerJson.getJSONArray("lifesAssured").getJSONObject(3).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(5).get("premiumAmount").toString();
				ApiHelper.AssertEquals("FuneralBenefit Parent premium amount on R35 000", ParentPremiumAmount35K, ParentPremAmount35K, test);
				
				String ParentPremAmount40K = innerJson.getJSONArray("lifesAssured").getJSONObject(3).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(6).get("premiumAmount").toString();
				ApiHelper.AssertEquals("FuneralBenefit Parent premium amount on R40 000", ParentPremiumAmount40K, ParentPremAmount40K, test);
				
				String ParentPremAmount45K = innerJson.getJSONArray("lifesAssured").getJSONObject(3).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(7).get("premiumAmount").toString();
				ApiHelper.AssertEquals("FuneralBenefit Parentpremium amount on R45 000", ParentPremiumAmount45K, ParentPremAmount45K, test);
				
				String ParentPremAmount50K = innerJson.getJSONArray("lifesAssured").getJSONObject(3).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(8).get("premiumAmount").toString();
				ApiHelper.AssertEquals("FuneralBenefit Parent premium amount on R50 000", ParentPremiumAmount50K, ParentPremAmount50K, test);
			
				
// Extended child
				String extendedChildPremAmount5K = innerJson.getJSONArray("lifesAssured").getJSONObject(4).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(0).get("premiumAmount").toString();
				...
				String extendedChildPremAmount10K = innerJson.getJSONArray("lifesAssured").getJSONObject(4).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(1).get("premiumAmount").toString();
				...
				String extendedChildPremAmount15K = innerJson.getJSONArray("lifesAssured").getJSONObject(4).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(2).get("premiumAmount").toString();
				...
				String extendedChildPremAmount20K = innerJson.getJSONArray("lifesAssured").getJSONObject(4).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(3).get("premiumAmount").toString();
				...
				String extendedChildPremAmount25K = innerJson.getJSONArray("lifesAssured").getJSONObject(4).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(4).get("premiumAmount").toString();
				...
				String extendedChildPremAmount30K = innerJson.getJSONArray("lifesAssured").getJSONObject(4).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(5).get("premiumAmount").toString();
				...
				// Extended adult
				String extendedAdultPremAmount5K = innerJson.getJSONArray("lifesAssured").getJSONObject(5).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(0).get("premiumAmount").toString();
				...
				String extendedAdultPremAmount10K = innerJson.getJSONArray("lifesAssured").getJSONObject(5).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(1).get("premiumAmount").toString();
				...
				String extendedAdultPremAmount15K = innerJson.getJSONArray("lifesAssured").getJSONObject(5).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(2).get("premiumAmount").toString();
				...
				String extendedAdultPremAmount20K = innerJson.getJSONArray("lifesAssured").getJSONObject(5).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(3).get("premiumAmount").toString();
				...
				String extendedAdultPremAmount25K = innerJson.getJSONArray("lifesAssured").getJSONObject(5).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(4).get("premiumAmount").toString();
				...
				String extendedAdultPremAmount30K = innerJson.getJSONArray("lifesAssured").getJSONObject(5).getJSONArray("benefits").getJSONObject(0).getJSONArray("premiums").getJSONObject(5).get("premiumAmount").toString();
